...
|--------------------------------------------------------------------------
|
| Define here the array for the nice names of the multilingual fields.
|
*/

foreach(config('app.locales') as $locale){
    $localized_attributes[$locale] =
        [
            'title' => 'título',
            'name' => 'nombre',
            'seo_title' => 'título',
            'seo_description' => 'descripción',
            'robots_id' => 'robots (indexación)',
            'slug' => 'slug'
        ];
}
...
return [
    ...
    */
    ...
    'alpha_dash'           => 'El campo :attribute solo puede contener letras, números y guiones (a-z, 0-9, -_).',
