        ...
        <div class="desktop-nav-intranet">
            ...
            <div class="menu-options menu-intranet">
                <div class="menu-option">
                    ...
                    <div class="menu-option-bar-intranet @if($route == 'gallery') active @endif"></div>
                </div>
                <div class="menu-option">
                    <a href="{{ route('promotion') }}">Promoció</a>
                    <div class="menu-option-bar-intranet @if($route == 'promotion') active @endif"></div>
                </div>
                <div class="menu-option">
                    <a href="{{ route('perks') }}">Avantatges</a>
                    <div class="menu-option-bar-intranet @if($route == 'perks') active @endif"></div>
                </div>
                <div class="menu-option">
                    <a href="#">Borsa treball</a>
