...
<div class="contacte main-section section-paddings">
	...
	<div class="contacte-form">
		...
		<form action="{{ route('contact-send') }}" method="post">
			...
			<input type="checkbox" name="chk3" id="chk3" class="chkrad X fade"><label for="chk3"><span></span>He llegit i accepto la política de privacitat.</label>
