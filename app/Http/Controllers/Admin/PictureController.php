...
use App\Http\Requests\Admin\Picture\PictureCreateRequest as CreateRequest;
use App\Http\Requests\Admin\Picture\PictureUpdateRequest as UpdateRequest;
...
class PictureController extends AdminController
{
    ...
    {
        parent::__construct(new Picture);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $users = User::whereHas('promotions', function (Builder $query) use ($entry) {
            $query->where('id', 'like', $entry->gallery->promotion_id);
        })->pluck('name','id');

        return parent::renderEdit($updateRequest, compact('entry', 'locale','users'));
    }
